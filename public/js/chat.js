...
if(attachment.value != '' && attachment.value !=null && attachment.value !=undefined){
  ...
  ownMessageDiv.innerHTML += '<div style="width:65%; background-color:#FFC066; font-size:1em; text-align:left; margin-left:6px; margin-right:6px; margin-bottom:6px; float:right"><span style="color:black; font-weight:bold; font-size:1em;">' + sender + '</span>' + '<br>' + '<span><a href=/upload/'+ attachment.value.split('\\').pop() + ' target="_blank">' + attachment.value.split('\\').pop() + '</a></span></div><br>';
...
ownMessageDiv.innerHTML += '<div style="width:65%; background-color:#FFC066; font-size:1em; text-align:left; margin-left:6px; margin-right:6px; margin-bottom:6px; float:right"><span style="color:black; width:100%; font-size:1em; font-weight:bold;">'+ sender + '</span>' + '<br>' + "<span>" + val + '</span></div><br>';
...
socket.on('addFileToChat', function(usernameSender, fileName, receiver){
  ...
  html = '<div style="width:65%; background-color:#ccffef; font-size:1em; text-align:left; margin-left:6px; margin-right:6px; margin-bottom:6px; float:left"><span style="color:grey; font-size:1em;">' + senderName + '</span>' + '<br>' + '<span><a href=/upload/'+ fileName + ' target="_blank">' + fileName + '</a></span></div><br>';
...
socket.on('addToChat', function(usernameSender, message, userID, receiver){
  ...
  if(messageDiv == null){
    ...
    html = '<div style="width:65%; background-color:white; font-size:1em; text-align:left; margin-left:6px; margin-right:6px; margin-bottom:6px; float:left"><span style="color:black; font-size:1em; font-weight:bold">' + senderName + '</span>' + '<br>' + '<span">' + message + '</span></div></div><br>' ;
  ...
  html = '<div style="width:65%; background-color:white; font-size:1em; text-align:left; margin-left:6px; margin-right:6px; margin-bottom:6px; float:left"><span style="color:black; font-weight:bold; font-size:1em;">' + senderName + '</span>' + '<br>' + '<span">' + message + '</span></div></div><br>' ;
  messageDiv.innerHTML += html;
...
socket.on('currentClients', function(data){
  ...
  if(clients!=null) {
    ...
    users.forEach(function(u){
      ...
      <img id="online" width="15" height="15" src="css/online2.png"><img id="userprofile" width="30" height="30" src="css/userprofile.jpg">
